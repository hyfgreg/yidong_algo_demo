...
def get_sbwplan_prod(sbw_ostation, sbw_dstation):
    ...
    find_route = db.mt.find_one({"origin": sbw_ostation, "destination": sbw_dstation})
    # print(find_route)
...
from util_v_0_2.data import ydline, ydstation, stationTime, sbwstation,sbwtime,sbwline, busSchedule
